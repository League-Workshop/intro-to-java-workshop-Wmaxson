...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	BufferedImage maze;
	final int frameWidth = 1920;
	final int frameHeight = 1080;

	ScaryMaze() throws Exception {
		// 1. Use this online tool to make a maze image and drop it into your day5
		// package:
		maze = ImageIO.read(getClass().getResource("LevelOne.jpg"));
	...
	public void mouseMoved(MouseEvent e) {
		...
		if (mouseColor == -16252721) {
			JOptionPane.showMessageDialog(null,
					"Good Job! you did a do. That was pretty hard, right? Maybe we can cool off with something a wee bit easier.");
	...
	private void scare() {
		...
		// 7. find a scary sound and put it in the day5 package where you put your maze
		// picture. You can find a sound on freesound.org. Log in as
		// leagueofamazing/code4life.
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("The_Wilhelm_scream_sound_effect.wav"));
		// 8. play the scary sound. Hint: type "sound" and then a period.
		sound.play();
		// 9. drop an image into your day5 package, and use the showScaryImage method to
		// scare your victim!
